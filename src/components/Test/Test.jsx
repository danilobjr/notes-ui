...
class Test extends Component { 
    ...
    render() {
        return (
            <Layout
                appTitle="JS Channel Notes"
                drawerItems={[
                    <DrawerItem key="1" iconName="file" text="Notes" onClick={() => console.log('Notes clicked')} />,
                    <DrawerItem key="2" iconName="list" text="Lists" onClick={() => console.log('Lists clicked')} />
                ]}
            >
                <div style={style.cardsView}>
                    <div style={style.centeredContainer}>
                        <FloatingInput
                ...
                <FAB iconName="plus" onClick={() => console.log('FAB clicked')} />
            </Layout>
        );
    }
